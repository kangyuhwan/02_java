...
public class StringApiTest {
	...
	public static void main(String[] args) {
		...
		// (1) charAt(int) : 특정 인덱스의 문자 1개 얻어냄
		System.out.println(str1.charAt(2)); //c
		// (2) concat(String) : 문자열 붙인 결과 리턴
		System.out.println(str1.concat(str2)); //abcdef
		// (3) substring(int) : 입력된 인덱스에서 마지막문자까지 리턴
		System.out.println(str3.substring(1)); //yz
		// (4) substring(int, int)
		//abcdefxyz
		System.out.println(str1.concat(str2).concat(str2).substring(2, 5));

		// (5)replace(int, char) : 앞의 매개변수 문자를 뒤 매개변수
