 ...
 * 기본제공 타입은? : String, Scanner ...
 * 클래스 디자인을 할 때는 추상화작업이 필요
 * 
 * 속성 : 현재의 속도 (===> 변수)
 * 기능 : 가속, 정지  (==> 메소드)
 * 
 ...
 * 
 */
public class Car { //category를 만든 것
	...
	public int accelerate(int value) {
		velocity += value; //가속을 더한다.
		
		return velocity; //velocity를 return한다.
	}
	...
	public void print() {
		System.out.printf("이 차의 현재 속도 %d km/h %n%n", velocity);
	}
